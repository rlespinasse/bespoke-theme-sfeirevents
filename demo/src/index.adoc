...
//:school-level: 200
//:school-level: 300
:twitter-hashtag: #thecurrentsfeirschool
:twitter-sfeiragency: @twitterhandle
:wifi-sid: OUR_WIFI_NAME
:wifi-password: OUR_WIFI_PASSWORD
